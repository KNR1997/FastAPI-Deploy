...
class User(BaseModel, TimestampMixin):
    ...
    first_name = fields.CharField(max_length=100, null=True, description="First Name")
    last_name = fields.CharField(max_length=100, null=True, description="Last Name")
    name_with_initials = fields.CharField(max_length=100, null=True, description="Name with Initials")
    ...
    phone = fields.CharField(max_length=20, null=True, description="Phone number", index=True)
    nic = fields.CharField(max_length=30, null=True, description="NIC number")
    ...
    last_login = fields.DatetimeField(null=True, description="Last-login", index=True)
